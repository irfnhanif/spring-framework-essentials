...
public class AccountClientTests {
	...
	public void addAndDeleteBeneficiary() {
		...
		URI locationOfNewBeneficiary = restTemplate.postForLocation(BASE_URL + "/accounts/{accountId}/beneficiaries", beneficiaryName, "1");
		
		// TODO-14: Retrieve the Beneficiary you just created from the location that was returned
		Beneficiary newBeneficiary = restTemplate.getForObject(locationOfNewBeneficiary, Beneficiary.class); // Modify this line to use the restTemplate
		
		assertNotNull(newBeneficiary);
		assertEquals("David", newBeneficiary.getName());
		
		// TODO-15: Delete the newly created Beneficiary
		restTemplate.delete(locationOfNewBeneficiary);
		...
		HttpClientErrorException httpClientErrorException = assertThrows(HttpClientErrorException.class, () -> {
			...
			//   was not successful.
			restTemplate.getForObject(locationOfNewBeneficiary, Beneficiary.class);
		});
